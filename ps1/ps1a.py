...
def greedy_cow_transport(cows, limit=10):
    ...
    """
    # TODO: Your code here
    ##we need to sort the cows from the largest one to the lowest one
    cows_copy = sorted(cows, key=cows.get, reverse=True)  ##make a list with the weights of the cows
    result = []
